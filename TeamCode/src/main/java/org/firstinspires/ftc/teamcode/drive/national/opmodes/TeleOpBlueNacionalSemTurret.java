...
public class TeleOpBlueNacionalSemTurret extends OpMode {
    ...
    private final Pose startTeleop = new Pose(13.25, 17.7 / 2, 0);
    ...
    public void init() {
        ...
        telemetry.addData("Status", "Blue Nacional SEM TURRET. GP1: drive, LT intake, RT flap, A shooter, B modo, D-Pad. GP2: X escala, Y goal, B reset, RB Limelight.");
        telemetry.update();
    }
    ...
    public void loop() {
        ...
        // Recalibrar goal pela direção do robô (sem turret)
