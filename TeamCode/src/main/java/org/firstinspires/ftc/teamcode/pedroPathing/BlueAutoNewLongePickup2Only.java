...
/**
 * Autônomo Blue Longe (só Pickup2 x2): score do preload + duas vezes grabPickup2 e scorePickup2.
 * Mesma lógica do Blue Longe, mas sem pickup1; turret travada (não se mexe).
 */
