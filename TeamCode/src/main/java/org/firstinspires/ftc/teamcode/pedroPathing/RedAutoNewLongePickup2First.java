...
/**
 * Autônomo Red Longe (Pickup2 primeiro): igual ao Red Longe, mas realiza
 * grabPickup2 e scorePickup2 antes de grabPickup1, endGrabPickup1 e scorePickup1.
 */
@Autonomous(name = "Red Longe 2º Pickup", group = "National")
public class RedAutoNewLongePickup2First extends OpMode {
