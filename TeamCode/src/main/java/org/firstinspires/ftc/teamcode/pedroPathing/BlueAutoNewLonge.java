...
public class BlueAutoNewLonge extends OpMode {
    ...
    private final Pose startPose = new Pose(64, 8, Math.toRadians(180)); // Start Pose of our robot.
    private final Pose scorePose = new Pose(64, 9, Math.toRadians(180)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose(40, 35, Math.toRadians(180)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose endPickup1Pose = new Pose(10, 35, Math.toRadians(180)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(10, 9, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.
