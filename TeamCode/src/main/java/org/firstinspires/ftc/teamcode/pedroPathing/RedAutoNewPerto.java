...
@Disabled
@Autonomous(name = "Red Perto (legado)", group = "National")
public class RedAutoNewPerto extends OpMode {
    ...
    private PathChain grabPickup1, scorePickup1, grabPickup2, scorePickup2, end, openGate, setToGate, scorePickup3;
