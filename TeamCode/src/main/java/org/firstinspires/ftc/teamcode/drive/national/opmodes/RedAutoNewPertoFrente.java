...
/**
 * Autônomo Red Perto Frente: variação com apenas start→score → score→pickup2 → pickup2→score → end.
 * Espelhado do Blue Perto Frente; mesmo hardware e lógica.
 */
@Autonomous(name = "Red Perto Frente", group = "National")
public class RedAutoNewPertoFrente extends OpMode {
