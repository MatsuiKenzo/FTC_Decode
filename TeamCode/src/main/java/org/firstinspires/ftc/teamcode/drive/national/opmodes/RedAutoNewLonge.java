...
/**
 * Autônomo Red Longe (trás): trajetórias do RedAutoNewLonge; intake/shooter ligados o tempo todo;
 * turret travada em -135°; em cada scorePose espera estabilizar, atira (flap) e segue.
 */
@Autonomous(name = "Red Longe", group = "National")
public class RedAutoNewLonge extends OpMode {
    ...
    // Poses do autônomo de trás (Longe) - Red
