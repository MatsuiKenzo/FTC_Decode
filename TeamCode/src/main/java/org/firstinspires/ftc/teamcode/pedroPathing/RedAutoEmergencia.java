...
/**
 * Autônomo de emergência Red: posicione o robô na mesma start pose do Red Longe.
 * Apenas vai em linha reta até a pose inicial do TeleOp Red (130.75, 8.85, 0°).
 * Sem shooter, intake ou turret — só drive. Use só se necessário.
 */
@Autonomous(name = "Red Emergencia", group = "National")
public class RedAutoEmergencia extends OpMode {

    private Follower follower;

    /** Mesma start pose do Red Longe. */
    private final Pose startPose = new Pose(80, 8, Math.toRadians(0));
    /** Pose inicial do TeleOp Red (espelhada: 144 - 13.25, 8.85, 0°). */
    private final Pose endPose = new Pose(144.0 - 13.25, 17.7 / 2, 0);
    ...
    public void init() {
        ...
        telemetry.addData("Status", "Red Emergencia: start Longe -> pose TeleOp. So drive.");
        telemetry.update();
    }
